...
const Navbar = () => {
  ...
  return (
    <section className="sticky h-[80px] top-0 left-0 right-0 z-30 ">
      <header className="bg-white px-8 flex justify-between py-4  items-center">
        <Link to={"/"}>
          <div className="ml-2 cursor-pointer text-2xl text-primary-blue font-bold uppercase">
            Stage Embauche
          </div>
        </Link>
        <div className="text-2xl lg:hidden" onClick={handleClick}>
